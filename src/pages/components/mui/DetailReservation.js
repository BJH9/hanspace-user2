...
import OnetimeDataGrid from "../../../sections/_examples/mui/data-grid/OnetimeDataGrid";
import DetailDataGrid from "../../../sections/_examples/mui/data-grid/DetailDataGrid";
import {
  deleteMultiRecord,
  deleteOneRecord,
  readEachRegularRecord,
...
export default function DetailReservation({ id, site }) {
  ...
  const readReserve = async () => {
    await readEachRegularRecord(site.id, id).then(function (info) {
      setData(info);
    });
  };
  ...
  const confirmDelete = async () => {
    ...
    setData(await readEachRegularRecord(site.id, id));
    setDel([]);
    setOpen(false);
  };
