...
// @mui
import { Card, Button, Container, DialogTitle, Box, Dialog } from '@mui/material';
// redux
...
export default function HisSpaceCalendar({ onHandleOpen }) {
  ...
  return (
    <>
      ...
      <Container maxWidth={themeStretch ? false : 'xl'}>
        ...
        <Card>
          <Box container display="flex" justifyContents={'right'} fullWidth>
            <Button sx={{ color: 'black', alignContent: 'right' }} onClick={onHandleOpen}>
              X
            </Button>
          </Box>
          <StyledCalendar>
